...
interface ConfigPagesProps { page: Page; config: AppConfig; logs: LogEntry[]; onChange: (config: AppConfig) => Promise<boolean>; onImport: () => Promise<void>; onExport: () => Promise<void>; onChooseProjectDirectory: () => Promise<boolean>; }
...
export function ConfigPages({ page, config, logs, onChange, onImport, onExport, onChooseProjectDirectory }: ConfigPagesProps) {
